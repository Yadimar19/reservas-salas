...
const corsOptions = {
  origin: [
    ...
    'http://localhost:5500',
    'https://Yadimar19.github.io',  // La página ya publicada en GitHub Pages
  ],
...
app.delete('/salas/:id', (req,res)=>{
  ...
  let reservaEliminada = null;
  if (indiceReserva !== -1) {
    reservaEliminada = reservas.splice(indiceReserva, 1)[0];
  }
  res.json({
    mensaje: 'Sala eliminada correctamente' + (reservaEliminada ? ' junto con su reserva asociada' : ''),
    sala: salaEliminada,
